...
// v776：背景滚动冻结（引用计数，支持弹窗叠弹窗）
let _modalScrollLockN = 0;
...
// v799: 滚动锁自愈——弹窗全部关闭时若锁未归零（同步/异步时序卡住），强制解锁，避免全页面划不动
function healScrollLock() {
  try {
    const ov = document.getElementById('modalOverlay');
    if (ov && ov.classList.contains('show')) return;
    const de = document.documentElement, b = document.body, mb = document.getElementById('mainBody');
    const stuck = _modalScrollLockN !== 0
      || (de && de.classList.contains('modal-lock'))
      || (b && b.style.overflow === 'hidden')
      || (mb && mb.style.overflow === 'hidden');
    _modalScrollLockN = 0;
    if (!stuck) return;
    if (de) de.classList.remove('modal-lock');
    if (b) { b.style.overflow = ''; try { delete b.dataset.prevOverflow; } catch (e) {} }
    if (mb) { mb.style.overflow = ''; try { delete mb.dataset.prevOverflow; } catch (e) {} }
  } catch (e) {}
}
...
let _txtTplPickerCat = ''; // v776：约稿单内文本模板插入弹窗的分类筛选（固定选中一个分类，不再有「全部」）
...
function closeModal() {
  ...
  // v776：解除背景滚动冻结（有内层弹窗时等最后一层关闭才恢复）
  _modalScrollLockN = Math.max(0, _modalScrollLockN - 1); _applyModalScrollLock();
...
const LUCIDE_SVG = {
  ...
  "align-center": '<!-- @license lucide-static v0.544.0 - ISC --> <svg class="lucide lucide-align-center" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" > <path d="M21 5H3" /> <path d="M17 12H7" /> <path d="M19 19H5" />',
  "align-justify": '<!-- @license lucide-static v0.544.0 - ISC --> <svg class="lucide lucide-align-justify" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" > <path d="M3 5h18" /> <path d="M3 12h18" /> <path d="M3 19h18" />',
  "align-left": '<!-- @license lucide-static v0.544.0 - ISC --> <svg class="lucide lucide-align-left" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" > <path d="M21 5H3" /> <path d="M15 12H3" /> <path d="M17 19H3" />',
  "align-right": '<!-- @license lucide-static v0.544.0 - ISC --> <svg class="lucide lucide-align-right" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" > <path d="M21 5H3" /> <path d="M21 12H9" /> <path d="M21 19H7" />',
  "arrow-down": '<!-- @license lucide-static v0.544.0 - ISC --> <svg class="lucide lucide-arrow-down" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" > <path d="M12 5v14" /> <path d="m19 12-7 7-7-7" />',
  "arrow-left": '<!-- @license lucide-static v0.544.0 - ISC --> <svg class="lucide lucide-arrow-left" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" > <path d="m12 19-7-7 7-7" /> <path d="M19 12H5" />',
  "arrow-right": '<!-- @license lucide-static v0.544.0 - ISC --> <svg class="lucide lucide-arrow-right" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" > <path d="M5 12h14" /> <path d="m12 5 7 7-7 7" />',
  "arrow-up": '<!-- @license lucide-static v0.544.0 - ISC --> <svg class="lucide lucide-arrow-up" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" > <path d="m5 12 7-7 7 7" /> <path d="M12 19V5" />',
  "arrow-up-left": '<!-- @license lucide-static v0.544.0 - ISC --> <svg class="lucide lucide-arrow-up-left" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" > <path d="M7 17V7h10" /> <path d="M17 17 7 7" />',
  "arrow-up-right": '<!-- @license lucide-static v0.544.0 - ISC --> <svg class="lucide lucide-arrow-up-right" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" > <path d="M7 7h10v10" /> <path d="M7 17 17 7" />',
  "award": '<!-- @license lucide-static v0.544.0 - ISC --> <svg class="lucide lucide-award" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" > <path d="m15.477 12.89 1.515 8.526a.5.5 0 0 1-.81.47l-3.58-2.687a1 1 0 0 0-1.197 0l-3.586 2.686a.5.5 0 0 1-.81-.469l1.514-8.526" /> <circle cx="12" cy="8" r="6" />',
  "bell": '<!-- @license lucide-static v0.544.0 - ISC --> <svg class="lucide lucide-bell" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" > <path d="M10.268 21a2 2 0 0 0 3.464 0" /> <path d="M3.262 15.326A1 1 0 0 0 4 17h16a1 1 0 0 0 .74-1.673C19.41 13.956 18 12.499 18 8A6 6 0 0 0 6 8c0 4.499-1.411 5.956-2.738 7.326" />',
  "bell-off": '<!-- @license lucide-static v0.544.0 - ISC --> <svg class="lucide lucide-bell-off" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" > <path d="M10.268 21a2 2 0 0 0 3.464 0" /> <path d="M17 17H4a1 1 0 0 1-.74-1.673C4.59 13.956 6 12.499 6 8a6 6 0 0 1 .258-1.742" /> <path d="m2 2 20 20" /> <path d="M8.668 3.01A6 6 0 0 1 18 8c0 2.687.77 4.653 1.707 6.05" />',
  "bell-ring": '<!-- @license lucide-static v0.544.0 - ISC --> <svg class="lucide lucide-bell-ring" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" > <path d="M10.268 21a2 2 0 0 0 3.464 0" /> <path d="M22 8c0-2.3-.8-4.3-2-6" /> <path d="M3.262 15.326A1 1 0 0 0 4 17h16a1 1 0 0 0 .74-1.673C19.41 13.956 18 12.499 18 8A6 6 0 0 0 6 8c0 4.499-1.411 5.956-2.738 7.326" /> <path d="M4 2C2.8 3.7 2 5.7 2 8" />',
  "bold": '<!-- @license lucide-static v0.544.0 - ISC --> <svg class="lucide lucide-bold" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" > <path d="M6 12h9a4 4 0 0 1 0 8H7a1 1 0 0 1-1-1V5a1 1 0 0 1 1-1h7a4 4 0 0 1 0 8" />',
  "bookmark": '<!-- @license lucide-static v0.544.0 - ISC --> <svg class="lucide lucide-bookmark" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" > <path d="m19 21-7-4-7 4V5a2 2 0 0 1 2-2h10a2 2 0 0 1 2 2v16z" />',
  "bookmark-check": '<!-- @license lucide-static v0.544.0 - ISC --> <svg class="lucide lucide-bookmark-check" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" > <path d="m19 21-7-4-7 4V5a2 2 0 0 1 2-2h10a2 2 0 0 1 2 2Z" /> <path d="m9 10 2 2 4-4" />',
  "check-square": '<!-- @license lucide-static v0.544.0 - ISC --> <svg class="lucide lucide-check-square" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" > <path d="M21 10.656V19a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h12.344" /> <path d="m9 11 3 3L22 4" />',
  "chevron-down": '<!-- @license lucide-static v0.544.0 - ISC --> <svg class="lucide lucide-chevron-down" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" > <path d="m6 9 6 6 6-6" />',
  "chevron-left": '<!-- @license lucide-static v0.544.0 - ISC --> <svg class="lucide lucide-chevron-left" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" > <path d="m15 18-6-6 6-6" />',
  "chevron-right": '<!-- @license lucide-static v0.544.0 - ISC --> <svg class="lucide lucide-chevron-right" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" > <path d="m9 18 6-6-6-6" />',
  "chevron-up": '<!-- @license lucide-static v0.544.0 - ISC --> <svg class="lucide lucide-chevron-up" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" > <path d="m18 15-6-6-6 6" />',
  "chevrons-down": '<!-- @license lucide-static v0.544.0 - ISC --> <svg class="lucide lucide-chevrons-down" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" > <path d="m7 6 5 5 5-5" /> <path d="m7 13 5 5 5-5" />',
  "chevrons-left": '<!-- @license lucide-static v0.544.0 - ISC --> <svg class="lucide lucide-chevrons-left" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" > <path d="m11 17-5-5 5-5" /> <path d="m18 17-5-5 5-5" />',
  "chevrons-right": '<!-- @license lucide-static v0.544.0 - ISC --> <svg class="lucide lucide-chevrons-right" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" > <path d="m6 17 5-5-5-5" /> <path d="m13 17 5-5-5-5" />',
  "chevrons-up": '<!-- @license lucide-static v0.544.0 - ISC --> <svg class="lucide lucide-chevrons-up" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" > <path d="m17 11-5-5-5 5" /> <path d="m17 18-5-5-5 5" />',
  "circle": '<!-- @license lucide-static v0.544.0 - ISC --> <svg class="lucide lucide-circle" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" > <circle cx="12" cy="12" r="10" />',
  "copy": '<!-- @license lucide-static v0.544.0 - ISC --> <svg class="lucide lucide-copy" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" > <rect width="14" height="14" x="8" y="8" rx="2" ry="2" /> <path d="M4 16c-1.1 0-2-.9-2-2V4c0-1.1.9-2 2-2h10c1.1 0 2 .9 2 2" />',
  "corner-down-right": '<!-- @license lucide-static v0.544.0 - ISC --> <svg class="lucide lucide-corner-down-right" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" > <path d="m15 10 5 5-5 5" /> <path d="M4 4v7a4 4 0 0 0 4 4h12" />',
  "cpu": '<!-- @license lucide-static v0.544.0 - ISC --> <svg class="lucide lucide-cpu" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" > <path d="M12 20v2" /> <path d="M12 2v2" /> <path d="M17 20v2" /> <path d="M17 2v2" /> <path d="M2 12h2" /> <path d="M2 17h2" /> <path d="M2 7h2" /> <path d="M20 12h2" /> <path d="M20 17h2" /> <path d="M20 7h2" /> <path d="M7 20v2" /> <path d="M7 2v2" /> <rect x="4" y="4" width="16" height="16" rx="2" /> <rect x="8" y="8" width="8" height="8" rx="1" />',
  "crosshair": '<!-- @license lucide-static v0.544.0 - ISC --> <svg class="lucide lucide-crosshair" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" > <circle cx="12" cy="12" r="10" /> <line x1="22" x2="18" y1="12" y2="12" /> <line x1="6" x2="2" y1="12" y2="12" /> <line x1="12" x2="12" y1="6" y2="2" /> <line x1="12" x2="12" y1="22" y2="18" />',
  "crown": '<!-- @license lucide-static v0.544.0 - ISC --> <svg class="lucide lucide-crown" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" > <path d="M11.562 3.266a.5.5 0 0 1 .876 0L15.39 8.87a1 1 0 0 0 1.516.294L21.183 5.5a.5.5 0 0 1 .798.519l-2.834 10.246a1 1 0 0 1-.956.734H5.81a1 1 0 0 1-.957-.734L2.02 6.02a.5.5 0 0 1 .798-.519l4.276 3.664a1 1 0 0 0 1.516-.294z" /> <path d="M5 21h14" />',
  "database": '<!-- @license lucide-static v0.544.0 - ISC --> <svg class="lucide lucide-database" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" > <ellipse cx="12" cy="5" rx="9" ry="3" /> <path d="M3 5V19A9 3 0 0 0 21 19V5" /> <path d="M3 12A9 3 0 0 0 21 12" />',
  "diamond": '<!-- @license lucide-static v0.544.0 - ISC --> <svg class="lucide lucide-diamond" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" > <path d="M2.7 10.3a2.41 2.41 0 0 0 0 3.41l7.59 7.59a2.41 2.41 0 0 0 3.41 0l7.59-7.59a2.41 2.41 0 0 0 0-3.41l-7.59-7.59a2.41 2.41 0 0 0-3.41 0Z" />',
  "edit-2": '<!-- @license lucide-static v0.544.0 - ISC --> <svg class="lucide lucide-edit-2" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" > <path d="M21.174 6.812a1 1 0 0 0-3.986-3.987L3.842 16.174a2 2 0 0 0-.5.83l-1.321 4.352a.5.5 0 0 0 .623.622l4.353-1.32a2 2 0 0 0 .83-.497z" />',
  "edit-3": '<!-- @license lucide-static v0.544.0 - ISC --> <svg class="lucide lucide-edit-3" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" > <path d="M13 21h8" /> <path d="M21.174 6.812a1 1 0 0 0-3.986-3.987L3.842 16.174a2 2 0 0 0-.5.83l-1.321 4.352a.5.5 0 0 0 .623.622l4.353-1.32a2 2 0 0 0 .83-.497z" />',
  "expand": '<!-- @license lucide-static v0.544.0 - ISC --> <svg class="lucide lucide-expand" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" > <path d="m15 15 6 6" /> <path d="m15 9 6-6" /> <path d="M21 16v5h-5" /> <path d="M21 8V3h-5" /> <path d="M3 16v5h5" /> <path d="m3 21 6-6" /> <path d="M3 8V3h5" /> <path d="M9 9 3 3" />',
  "external-link": '<!-- @license lucide-static v0.544.0 - ISC --> <svg class="lucide lucide-external-link" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" > <path d="M15 3h6v6" /> <path d="M10 14 21 3" /> <path d="M18 13v6a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V8a2 2 0 0 1 2-2h6" />',
  "eye": '<!-- @license lucide-static v0.544.0 - ISC --> <svg class="lucide lucide-eye" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" > <path d="M2.062 12.348a1 1 0 0 1 0-.696 10.75 10.75 0 0 1 19.876 0 1 1 0 0 1 0 .696 10.75 10.75 0 0 1-19.876 0" /> <circle cx="12" cy="12" r="3" />',
  "eye-off": '<!-- @license lucide-static v0.544.0 - ISC --> <svg class="lucide lucide-eye-off" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" > <path d="M10.733 5.076a10.744 10.744 0 0 1 11.205 6.575 1 1 0 0 1 0 .696 10.747 10.747 0 0 1-1.444 2.49" /> <path d="M14.084 14.158a3 3 0 0 1-4.242-4.242" /> <path d="M17.479 17.499a10.75 10.75 0 0 1-15.417-5.151 1 1 0 0 1 0-.696 10.75 10.75 0 0 1 4.446-5.143" /> <path d="m2 2 20 20" />',
  "filter": '<!-- @license lucide-static v0.544.0 - ISC --> <svg class="lucide lucide-filter" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" > <path d="M10 20a1 1 0 0 0 .553.895l2 1A1 1 0 0 0 14 21v-7a2 2 0 0 1 .517-1.341L21.74 4.67A1 1 0 0 0 21 3H3a1 1 0 0 0-.742 1.67l7.225 7.989A2 2 0 0 1 10 14z" />',
  "flag": '<!-- @license lucide-static v0.544.0 - ISC --> <svg class="lucide lucide-flag" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" > <path d="M4 22V4a1 1 0 0 1 .4-.8A6 6 0 0 1 8 2c3 0 5 2 7.333 2q2 0 3.067-.8A1 1 0 0 1 20 4v10a1 1 0 0 1-.4.8A6 6 0 0 1 16 16c-3 0-5-2-8-2a6 6 0 0 0-4 1.528" />',
  "flag-triangle-right": '<!-- @license lucide-static v0.544.0 - ISC --> <svg class="lucide lucide-flag-triangle-right" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" > <path d="M6 22V2.8a.8.8 0 0 1 1.17-.71l11.38 5.69a.8.8 0 0 1 0 1.44L6 15.5" />',
  "flame": '<!-- @license lucide-static v0.544.0 - ISC --> <svg class="lucide lucide-flame" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" > <path d="M8.5 14.5A2.5 2.5 0 0 0 11 12c0-1.38-.5-2-1-3-1.072-2.143-.224-4.054 2-6 .5 2.5 2 4.9 4 6.5 2 1.6 3 3.5 3 5.5a7 7 0 1 1-14 0c0-1.153.433-2.294 1-3a2.5 2.5 0 0 0 2.5 2.5z" />',
  "flashlight": '<!-- @license lucide-static v0.544.0 - ISC --> <svg class="lucide lucide-flashlight" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" > <path d="M18 6c0 2-2 2-2 4v10a2 2 0 0 1-2 2h-4a2 2 0 0 1-2-2V10c0-2-2-2-2-4V2h12z" /> <line x1="6" x2="18" y1="6" y2="6" /> <line x1="12" x2="12" y1="12" y2="12" />',
  "frown": '<!-- @license lucide-static v0.544.0 - ISC --> <svg class="lucide lucide-frown" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" > <circle cx="12" cy="12" r="10" /> <path d="M16 16s-1.5-2-4-2-4 2-4 2" /> <line x1="9" x2="9.01" y1="9" y2="9" /> <line x1="15" x2="15.01" y1="9" y2="9" />',
  "gift": '<!-- @license lucide-static v0.544.0 - ISC --> <svg class="lucide lucide-gift" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" > <rect x="3" y="8" width="18" height="4" rx="1" /> <path d="M12 8v13" /> <path d="M19 12v7a2 2 0 0 1-2 2H7a2 2 0 0 1-2-2v-7" /> <path d="M7.5 8a2.5 2.5 0 0 1 0-5A4.8 8 0 0 1 12 8a4.8 8 0 0 1 4.5-5 2.5 2.5 0 0 1 0 5" />',
  "hard-drive": '<!-- @license lucide-static v0.544.0 - ISC --> <svg class="lucide lucide-hard-drive" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" > <line x1="22" x2="2" y1="12" y2="12" /> <path d="M5.45 5.11 2 12v6a2 2 0 0 0 2 2h16a2 2 0 0 0 2-2v-6l-3.45-6.89A2 2 0 0 0 16.76 4H7.24a2 2 0 0 0-1.79 1.11z" /> <line x1="6" x2="6.01" y1="16" y2="16" /> <line x1="10" x2="10.01" y1="16" y2="16" />',
  "headphones": '<!-- @license lucide-static v0.544.0 - ISC --> <svg class="lucide lucide-headphones" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" > <path d="M3 14h3a2 2 0 0 1 2 2v3a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-7a9 9 0 0 1 18 0v7a2 2 0 0 1-2 2h-1a2 2 0 0 1-2-2v-3a2 2 0 0 1 2-2h3" />',
  "heart": '<!-- @license lucide-static v0.544.0 - ISC --> <svg class="lucide lucide-heart" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" > <path d="M2 9.5a5.5 5.5 0 0 1 9.591-3.676.56.56 0 0 0 .818 0A5.49 5.49 0 0 1 22 9.5c0 2.29-1.5 4-3 5.5l-5.492 5.313a2 2 0 0 1-3 .019L5 15c-1.5-1.5-3-3.2-3-5.5" />',
  "heart-off": '<!-- @license lucide-static v0.544.0 - ISC --> <svg class="lucide lucide-heart-off" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" > <path d="M10.5 4.893a5.5 5.5 0 0 1 1.091.931.56.56 0 0 0 .818 0A5.49 5.49 0 0 1 22 9.5c0 1.872-1.002 3.356-2.187 4.655" /> <path d="m16.967 16.967-3.459 3.346a2 2 0 0 1-3 .019L5 15c-1.5-1.5-3-3.2-3-5.5a5.5 5.5 0 0 1 2.747-4.761" /> <path d="m2 2 20 20" />',
  "help-circle": '<!-- @license lucide-static v0.544.0 - ISC --> <svg class="lucide lucide-help-circle" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" > <circle cx="12" cy="12" r="10" /> <path d="M9.09 9a3 3 0 0 1 5.83 1c0 2-3 3-3 3" /> <path d="M12 17h.01" />',
  "image": '<!-- @license lucide-static v0.544.0 - ISC --> <svg class="lucide lucide-image" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" > <rect width="18" height="18" x="3" y="3" rx="2" ry="2" /> <circle cx="9" cy="9" r="2" /> <path d="m21 15-3.086-3.086a2 2 0 0 0-2.828 0L6 21" />',
  "image-off": '<!-- @license lucide-static v0.544.0 - ISC --> <svg class="lucide lucide-image-off" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" > <line x1="2" x2="22" y1="2" y2="22" /> <path d="M10.41 10.41a2 2 0 1 1-2.83-2.83" /> <line x1="13.5" x2="6" y1="13.5" y2="21" /> <line x1="18" x2="21" y1="12" y2="15" /> <path d="M3.59 3.59A1.99 1.99 0 0 0 3 5v14a2 2 0 0 0 2 2h14c.55 0 1.052-.22 1.41-.59" /> <path d="M21 15V5a2 2 0 0 0-2-2H9" />',
  "images": '<!-- @license lucide-static v0.544.0 - ISC --> <svg class="lucide lucide-images" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" > <path d="m22 11-1.296-1.296a2.4 2.4 0 0 0-3.408 0L11 16" /> <path d="M4 8a2 2 0 0 0-2 2v10a2 2 0 0 0 2 2h10a2 2 0 0 0 2-2" /> <circle cx="13" cy="7" r="1" fill="currentColor" /> <rect x="8" y="2" width="14" height="14" rx="2" />',
  "info": '<!-- @license lucide-static v0.544.0 - ISC --> <svg class="lucide lucide-info" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" > <circle cx="12" cy="12" r="10" /> <path d="M12 16v-4" /> <path d="M12 8h.01" />',
  "italic": '<!-- @license lucide-static v0.544.0 - ISC --> <svg class="lucide lucide-italic" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" > <line x1="19" x2="10" y1="4" y2="4" /> <line x1="14" x2="5" y1="20" y2="20" /> <line x1="15" x2="9" y1="4" y2="20" />',
  "key": '<!-- @license lucide-static v0.544.0 - ISC --> <svg class="lucide lucide-key" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" > <path d="m15.5 7.5 2.3 2.3a1 1 0 0 0 1.4 0l2.1-2.1a1 1 0 0 0 0-1.4L19 4" /> <path d="m21 2-9.6 9.6" /> <circle cx="7.5" cy="15.5" r="5.5" />',
  "key-round": '<!-- @license lucide-static v0.544.0 - ISC --> <svg class="lucide lucide-key-round" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" > <path d="M2.586 17.414A2 2 0 0 0 2 18.828V21a1 1 0 0 0 1 1h3a1 1 0 0 0 1-1v-1a1 1 0 0 1 1-1h1a1 1 0 0 0 1-1v-1a1 1 0 0 1 1-1h.172a2 2 0 0 0 1.414-.586l.814-.814a6.5 6.5 0 1 0-4-4z" /> <circle cx="16.5" cy="7.5" r=".5" fill="currentColor" />',
  "laptop": '<!-- @license lucide-static v0.544.0 - ISC --> <svg class="lucide lucide-laptop" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" > <path d="M18 5a2 2 0 0 1 2 2v8.526a2 2 0 0 0 .212.897l1.068 2.127a1 1 0 0 1-.9 1.45H3.62a1 1 0 0 1-.9-1.45l1.068-2.127A2 2 0 0 0 4 15.526V7a2 2 0 0 1 2-2z" /> <path d="M20.054 15.987H3.946" />',
  "list-checks": '<!-- @license lucide-static v0.544.0 - ISC --> <svg class="lucide lucide-list-checks" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" > <path d="M13 5h8" /> <path d="M13 12h8" /> <path d="M13 19h8" /> <path d="m3 17 2 2 4-4" /> <path d="m3 7 2 2 4-4" />',
  "list-ordered": '<!-- @license lucide-static v0.544.0 - ISC --> <svg class="lucide lucide-list-ordered" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" > <path d="M11 5h10" /> <path d="M11 12h10" /> <path d="M11 19h10" /> <path d="M4 4h1v5" /> <path d="M4 9h2" /> <path d="M6.5 20H3.4c0-1 2.6-1.925 2.6-3.5a1.5 1.5 0 0 0-2.6-1.02" />',
  "lock-keyhole": '<!-- @license lucide-static v0.544.0 - ISC --> <svg class="lucide lucide-lock-keyhole" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" > <circle cx="12" cy="16" r="1" /> <rect x="3" y="10" width="18" height="12" rx="2" /> <path d="M7 10V7a5 5 0 0 1 10 0v3" />',
  "log-in": '<!-- @license lucide-static v0.544.0 - ISC --> <svg class="lucide lucide-log-in" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" > <path d="m10 17 5-5-5-5" /> <path d="M15 12H3" /> <path d="M15 3h4a2 2 0 0 1 2 2v14a2 2 0 0 1-2 2h-4" />',
  "log-out": '<!-- @license lucide-static v0.544.0 - ISC --> <svg class="lucide lucide-log-out" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" > <path d="m16 17 5-5-5-5" /> <path d="M21 12H9" /> <path d="M9 21H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h4" />',
  "maximize": '<!-- @license lucide-static v0.544.0 - ISC --> <svg class="lucide lucide-maximize" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" > <path d="M8 3H5a2 2 0 0 0-2 2v3" /> <path d="M21 8V5a2 2 0 0 0-2-2h-3" /> <path d="M3 16v3a2 2 0 0 0 2 2h3" /> <path d="M16 21h3a2 2 0 0 0 2-2v-3" />',
  "maximize-2": '<!-- @license lucide-static v0.544.0 - ISC --> <svg class="lucide lucide-maximize-2" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" > <path d="M15 3h6v6" /> <path d="m21 3-7 7" /> <path d="m3 21 7-7" /> <path d="M9 21H3v-6" />',
  "medal": '<!-- @license lucide-static v0.544.0 - ISC --> <svg class="lucide lucide-medal" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" > <path d="M7.21 15 2.66 7.14a2 2 0 0 1 .13-2.2L4.4 2.8A2 2 0 0 1 6 2h12a2 2 0 0 1 1.6.8l1.6 2.14a2 2 0 0 1 .14 2.2L16.79 15" /> <path d="M11 12 5.12 2.2" /> <path d="m13 12 5.88-9.8" /> <path d="M8 7h8" /> <circle cx="12" cy="17" r="5" /> <path d="M12 18v-2h-.5" />',
  "meh": '<!-- @license lucide-static v0.544.0 - ISC --> <svg class="lucide lucide-meh" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" > <circle cx="12" cy="12" r="10" /> <line x1="8" x2="16" y1="15" y2="15" /> <line x1="9" x2="9.01" y1="9" y2="9" /> <line x1="15" x2="15.01" y1="9" y2="9" />',
  "memory-stick": '<!-- @license lucide-static v0.544.0 - ISC --> <svg class="lucide lucide-memory-stick" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" > <path d="M6 19v-3" /> <path d="M10 19v-3" /> <path d="M14 19v-3" /> <path d="M18 19v-3" /> <path d="M8 11V9" /> <path d="M16 11V9" /> <path d="M12 11V9" /> <path d="M2 15h20" /> <path d="M2 7a2 2 0 0 1 2-2h16a2 2 0 0 1 2 2v1.1a2 2 0 0 0 0 3.837V17a2 2 0 0 1-2 2H4a2 2 0 0 1-2-2v-5.1a2 2 0 0 0 0-3.837Z" />',
  "mic": '<!-- @license lucide-static v0.544.0 - ISC --> <svg class="lucide lucide-mic" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" > <path d="M12 19v3" /> <path d="M19 10v2a7 7 0 0 1-14 0v-2" /> <rect x="9" y="2" width="6" height="13" rx="3" />',
  "mic-off": '<!-- @license lucide-static v0.544.0 - ISC --> <svg class="lucide lucide-mic-off" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" > <path d="M12 19v3" /> <path d="M15 9.34V5a3 3 0 0 0-5.68-1.33" /> <path d="M16.95 16.95A7 7 0 0 1 5 12v-2" /> <path d="M18.89 13.23A7 7 0 0 0 19 12v-2" /> <path d="m2 2 20 20" /> <path d="M9 9v3a3 3 0 0 0 5.12 2.12" />',
  "minimize": '<!-- @license lucide-static v0.544.0 - ISC --> <svg class="lucide lucide-minimize" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" > <path d="M8 3v3a2 2 0 0 1-2 2H3" /> <path d="M21 8h-3a2 2 0 0 1-2-2V3" /> <path d="M3 16h3a2 2 0 0 1 2 2v3" /> <path d="M16 21v-3a2 2 0 0 1 2-2h3" />',
  "minimize-2": '<!-- @license lucide-static v0.544.0 - ISC --> <svg class="lucide lucide-minimize-2" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" > <path d="m14 10 7-7" /> <path d="M20 10h-6V4" /> <path d="m3 21 7-7" /> <path d="M4 14h6v6" />',
  "minus": '<!-- @license lucide-static v0.544.0 - ISC --> <svg class="lucide lucide-minus" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" > <path d="M5 12h14" />',
  "minus-circle": '<!-- @license lucide-static v0.544.0 - ISC --> <svg class="lucide lucide-minus-circle" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" > <circle cx="12" cy="12" r="10" /> <path d="M8 12h8" />',
  "minus-square": '<!-- @license lucide-static v0.544.0 - ISC --> <svg class="lucide lucide-minus-square" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" > <rect width="18" height="18" x="3" y="3" rx="2" /> <path d="M8 12h8" />',
  "monitor": '<!-- @license lucide-static v0.544.0 - ISC --> <svg class="lucide lucide-monitor" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" > <rect width="20" height="14" x="2" y="3" rx="2" /> <line x1="8" x2="16" y1="21" y2="21" /> <line x1="12" x2="12" y1="17" y2="21" />',
  "more-horizontal": '<!-- @license lucide-static v0.544.0 - ISC --> <svg class="lucide lucide-more-horizontal" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" > <circle cx="12" cy="12" r="1" /> <circle cx="19" cy="12" r="1" /> <circle cx="5" cy="12" r="1" />',
  "more-vertical": '<!-- @license lucide-static v0.544.0 - ISC --> <svg class="lucide lucide-more-vertical" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" > <circle cx="12" cy="12" r="1" /> <circle cx="12" cy="5" r="1" /> <circle cx="12" cy="19" r="1" />',
  "move": '<!-- @license lucide-static v0.544.0 - ISC --> <svg class="lucide lucide-move" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" > <path d="M12 2v20" /> <path d="m15 19-3 3-3-3" /> <path d="m19 9 3 3-3 3" /> <path d="M2 12h20" /> <path d="m5 9-3 3 3 3" /> <path d="m9 5 3-3 3 3" />',
  "pause": '<!-- @license lucide-static v0.544.0 - ISC --> <svg class="lucide lucide-pause" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" > <rect x="14" y="3" width="5" height="18" rx="1" /> <rect x="5" y="3" width="5" height="18" rx="1" />',
  "play": '<!-- @license lucide-static v0.544.0 - ISC --> <svg class="lucide lucide-play" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" > <path d="M5 5a2 2 0 0 1 3.008-1.728l11.997 6.998a2 2 0 0 1 .003 3.458l-12 7A2 2 0 0 1 5 19z" />',
  "play-circle": '<!-- @license lucide-static v0.544.0 - ISC --> <svg class="lucide lucide-play-circle" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" > <path d="M9 9.003a1 1 0 0 1 1.517-.859l4.997 2.997a1 1 0 0 1 0 1.718l-4.997 2.997A1 1 0 0 1 9 14.996z" /> <circle cx="12" cy="12" r="10" />',
  "plus": '<!-- @license lucide-static v0.544.0 - ISC --> <svg class="lucide lucide-plus" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" > <path d="M5 12h14" /> <path d="M12 5v14" />',
  "plus-circle": '<!-- @license lucide-static v0.544.0 - ISC --> <svg class="lucide lucide-plus-circle" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" > <circle cx="12" cy="12" r="10" /> <path d="M8 12h8" /> <path d="M12 8v8" />',
  "plus-square": '<!-- @license lucide-static v0.544.0 - ISC --> <svg class="lucide lucide-plus-square" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" > <rect width="18" height="18" x="3" y="3" rx="2" /> <path d="M8 12h8" /> <path d="M12 8v8" />',
  "power": '<!-- @license lucide-static v0.544.0 - ISC --> <svg class="lucide lucide-power" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" > <path d="M12 2v10" /> <path d="M18.4 6.6a9 9 0 1 1-12.77.04" />',
  "printer": '<!-- @license lucide-static v0.544.0 - ISC --> <svg class="lucide lucide-printer" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" > <path d="M6 18H4a2 2 0 0 1-2-2v-5a2 2 0 0 1 2-2h16a2 2 0 0 1 2 2v5a2 2 0 0 1-2 2h-2" /> <path d="M6 9V3a1 1 0 0 1 1-1h10a1 1 0 0 1 1 1v6" /> <rect x="6" y="14" width="12" height="8" rx="1" />',
  "qr-code": '<!-- @license lucide-static v0.544.0 - ISC --> <svg class="lucide lucide-qr-code" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" > <rect width="5" height="5" x="3" y="3" rx="1" /> <rect width="5" height="5" x="16" y="3" rx="1" /> <rect width="5" height="5" x="3" y="16" rx="1" /> <path d="M21 16h-3a2 2 0 0 0-2 2v3" /> <path d="M21 21v.01" /> <path d="M12 7v3a2 2 0 0 1-2 2H7" /> <path d="M3 12h.01" /> <path d="M12 3h.01" /> <path d="M12 16v.01" /> <path d="M16 12h1" /> <path d="M21 12v.01" /> <path d="M12 21v-1" />',
  "ruler": '<!-- @license lucide-static v0.544.0 - ISC --> <svg class="lucide lucide-ruler" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" > <path d="M21.3 15.3a2.4 2.4 0 0 1 0 3.4l-2.6 2.6a2.4 2.4 0 0 1-3.4 0L2.7 8.7a2.41 2.41 0 0 1 0-3.4l2.6-2.6a2.41 2.41 0 0 1 3.4 0Z" /> <path d="m14.5 12.5 2-2" /> <path d="m11.5 9.5 2-2" /> <path d="m8.5 6.5 2-2" /> <path d="m17.5 15.5 2-2" />',
  "scissors": '<!-- @license lucide-static v0.544.0 - ISC --> <svg class="lucide lucide-scissors" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" > <circle cx="6" cy="6" r="3" /> <path d="M8.12 8.12 12 12" /> <path d="M20 4 8.12 15.88" /> <circle cx="6" cy="18" r="3" /> <path d="M14.8 14.8 20 20" />',
  "server": '<!-- @license lucide-static v0.544.0 - ISC --> <svg class="lucide lucide-server" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" > <rect width="20" height="8" x="2" y="2" rx="2" ry="2" /> <rect width="20" height="8" x="2" y="14" rx="2" ry="2" /> <line x1="6" x2="6.01" y1="6" y2="6" /> <line x1="6" x2="6.01" y1="18" y2="18" />',
  "share": '<!-- @license lucide-static v0.544.0 - ISC --> <svg class="lucide lucide-share" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" > <path d="M12 2v13" /> <path d="m16 6-4-4-4 4" /> <path d="M4 12v8a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2v-8" />',
  "share-2": '<!-- @license lucide-static v0.544.0 - ISC --> <svg class="lucide lucide-share-2" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" > <circle cx="18" cy="5" r="3" /> <circle cx="6" cy="12" r="3" /> <circle cx="18" cy="19" r="3" /> <line x1="8.59" x2="15.42" y1="13.51" y2="17.49" /> <line x1="15.41" x2="8.59" y1="6.51" y2="10.49" />',
  "shield": '<!-- @license lucide-static v0.544.0 - ISC --> <svg class="lucide lucide-shield" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" > <path d="M20 13c0 5-3.5 7.5-7.66 8.95a1 1 0 0 1-.67-.01C7.5 20.5 4 18 4 13V6a1 1 0 0 1 1-1c2 0 4.5-1.2 6.24-2.72a1.17 1.17 0 0 1 1.52 0C14.51 3.81 17 5 19 5a1 1 0 0 1 1 1z" />',
  "shield-alert": '<!-- @license lucide-static v0.544.0 - ISC --> <svg class="lucide lucide-shield-alert" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" > <path d="M20 13c0 5-3.5 7.5-7.66 8.95a1 1 0 0 1-.67-.01C7.5 20.5 4 18 4 13V6a1 1 0 0 1 1-1c2 0 4.5-1.2 6.24-2.72a1.17 1.17 0 0 1 1.52 0C14.51 3.81 17 5 19 5a1 1 0 0 1 1 1z" /> <path d="M12 8v4" /> <path d="M12 16h.01" />',
  "shield-check": '<!-- @license lucide-static v0.544.0 - ISC --> <svg class="lucide lucide-shield-check" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" > <path d="M20 13c0 5-3.5 7.5-7.66 8.95a1 1 0 0 1-.67-.01C7.5 20.5 4 18 4 13V6a1 1 0 0 1 1-1c2 0 4.5-1.2 6.24-2.72a1.17 1.17 0 0 1 1.52 0C14.51 3.81 17 5 19 5a1 1 0 0 1 1 1z" /> <path d="m9 12 2 2 4-4" />',
  "shrink": '<!-- @license lucide-static v0.544.0 - ISC --> <svg class="lucide lucide-shrink" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" > <path d="m15 15 6 6m-6-6v4.8m0-4.8h4.8" /> <path d="M9 19.8V15m0 0H4.2M9 15l-6 6" /> <path d="M15 4.2V9m0 0h4.8M15 9l6-6" /> <path d="M9 4.2V9m0 0H4.2M9 9 3 3" />',
  "sliders-horizontal": '<!-- @license lucide-static v0.544.0 - ISC --> <svg class="lucide lucide-sliders-horizontal" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" > <path d="M10 5H3" /> <path d="M12 19H3" /> <path d="M14 3v4" /> <path d="M16 17v4" /> <path d="M21 12h-9" /> <path d="M21 19h-5" /> <path d="M21 5h-7" /> <path d="M8 10v4" /> <path d="M8 12H3" />',
  "sliders-vertical": '<!-- @license lucide-static v0.544.0 - ISC --> <svg class="lucide lucide-sliders-vertical" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" > <path d="M10 8h4" /> <path d="M12 21v-9" /> <path d="M12 8V3" /> <path d="M17 16h4" /> <path d="M19 12V3" /> <path d="M19 21v-5" /> <path d="M3 14h4" /> <path d="M5 10V3" /> <path d="M5 21v-7" />',
  "smartphone": '<!-- @license lucide-static v0.544.0 - ISC --> <svg class="lucide lucide-smartphone" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" > <rect width="14" height="20" x="5" y="2" rx="2" ry="2" /> <path d="M12 18h.01" />',
  "smile": '<!-- @license lucide-static v0.544.0 - ISC --> <svg class="lucide lucide-smile" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" > <circle cx="12" cy="12" r="10" /> <path d="M8 14s1.5 2 4 2 4-2 4-2" /> <line x1="9" x2="9.01" y1="9" y2="9" /> <line x1="15" x2="15.01" y1="9" y2="9" />',
  "sort-asc": '<!-- @license lucide-static v0.544.0 - ISC --> <svg class="lucide lucide-sort-asc" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" > <path d="m3 8 4-4 4 4" /> <path d="M7 4v16" /> <path d="M11 12h4" /> <path d="M11 16h7" /> <path d="M11 20h10" />',
  "sort-desc": '<!-- @license lucide-static v0.544.0 - ISC --> <svg class="lucide lucide-sort-desc" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" > <path d="m3 16 4 4 4-4" /> <path d="M7 20V4" /> <path d="M11 4h10" /> <path d="M11 8h7" /> <path d="M11 12h4" />',
  "sparkle": '<!-- @license lucide-static v0.544.0 - ISC --> <svg class="lucide lucide-sparkle" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" > <path d="M11.017 2.814a1 1 0 0 1 1.966 0l1.051 5.558a2 2 0 0 0 1.594 1.594l5.558 1.051a1 1 0 0 1 0 1.966l-5.558 1.051a2 2 0 0 0-1.594 1.594l-1.051 5.558a1 1 0 0 1-1.966 0l-1.051-5.558a2 2 0 0 0-1.594-1.594l-5.558-1.051a1 1 0 0 1 0-1.966l5.558-1.051a2 2 0 0 0 1.594-1.594z" />',
  "square": '<!-- @license lucide-static v0.544.0 - ISC --> <svg class="lucide lucide-square" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" > <rect width="18" height="18" x="3" y="3" rx="2" />',
  "star": '<!-- @license lucide-static v0.544.0 - ISC --> <svg class="lucide lucide-star" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" > <path d="M11.525 2.295a.53.53 0 0 1 .95 0l2.31 4.679a2.123 2.123 0 0 0 1.595 1.16l5.166.756a.53.53 0 0 1 .294.904l-3.736 3.638a2.123 2.123 0 0 0-.611 1.878l.882 5.14a.53.53 0 0 1-.771.56l-4.618-2.428a2.122 2.122 0 0 0-1.973 0L6.396 21.01a.53.53 0 0 1-.77-.56l.881-5.139a2.122 2.122 0 0 0-.611-1.879L2.16 9.795a.53.53 0 0 1 .294-.906l5.165-.755a2.122 2.122 0 0 0 1.597-1.16z" />',
  "star-half": '<!-- @license lucide-static v0.544.0 - ISC --> <svg class="lucide lucide-star-half" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" > <path d="M12 18.338a2.1 2.1 0 0 0-.987.244L6.396 21.01a.53.53 0 0 1-.77-.56l.881-5.139a2.12 2.12 0 0 0-.611-1.879L2.16 9.795a.53.53 0 0 1 .294-.906l5.165-.755a2.12 2.12 0 0 0 1.597-1.16l2.309-4.679A.53.53 0 0 1 12 2" />',
  "stop-circle": '<!-- @license lucide-static v0.544.0 - ISC --> <svg class="lucide lucide-stop-circle" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" > <circle cx="12" cy="12" r="10" /> <rect x="9" y="9" width="6" height="6" rx="1" />',
  "strikethrough": '<!-- @license lucide-static v0.544.0 - ISC --> <svg class="lucide lucide-strikethrough" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" > <path d="M16 4H9a3 3 0 0 0-2.83 4" /> <path d="M14 12a4 4 0 0 1 0 8H6" /> <line x1="4" x2="20" y1="12" y2="12" />',
  "tablet": '<!-- @license lucide-static v0.544.0 - ISC --> <svg class="lucide lucide-tablet" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" > <rect width="16" height="20" x="4" y="2" rx="2" ry="2" /> <line x1="12" x2="12.01" y1="18" y2="18" />',
  "target": '<!-- @license lucide-static v0.544.0 - ISC --> <svg class="lucide lucide-target" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" > <circle cx="12" cy="12" r="10" /> <circle cx="12" cy="12" r="6" /> <circle cx="12" cy="12" r="2" />',
  "thumbs-down": '<!-- @license lucide-static v0.544.0 - ISC --> <svg class="lucide lucide-thumbs-down" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" > <path d="M17 14V2" /> <path d="M9 18.12 10 14H4.17a2 2 0 0 1-1.92-2.56l2.33-8A2 2 0 0 1 6.5 2H20a2 2 0 0 1 2 2v8a2 2 0 0 1-2 2h-2.76a2 2 0 0 0-1.79 1.11L12 22a3.13 3.13 0 0 1-3-3.88Z" />',
  "thumbs-up": '<!-- @license lucide-static v0.544.0 - ISC --> <svg class="lucide lucide-thumbs-up" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" > <path d="M7 10v12" /> <path d="M15 5.88 14 10h5.83a2 2 0 0 1 1.92 2.56l-2.33 8A2 2 0 0 1 17.5 22H4a2 2 0 0 1-2-2v-8a2 2 0 0 1 2-2h2.76a2 2 0 0 0 1.79-1.11L12 2a3.13 3.13 0 0 1 3 3.88Z" />',
  "toggle-left": '<!-- @license lucide-static v0.544.0 - ISC --> <svg class="lucide lucide-toggle-left" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" > <circle cx="9" cy="12" r="3" /> <rect width="20" height="14" x="2" y="5" rx="7" />',
  "toggle-right": '<!-- @license lucide-static v0.544.0 - ISC --> <svg class="lucide lucide-toggle-right" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" > <circle cx="15" cy="12" r="3" /> <rect width="20" height="14" x="2" y="5" rx="7" />',
  "triangle": '<!-- @license lucide-static v0.544.0 - ISC --> <svg class="lucide lucide-triangle" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" > <path d="M13.73 4a2 2 0 0 0-3.46 0l-8 14A2 2 0 0 0 4 21h16a2 2 0 0 0 1.73-3Z" />',
  "trophy": '<!-- @license lucide-static v0.544.0 - ISC --> <svg class="lucide lucide-trophy" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" > <path d="M10 14.66v1.626a2 2 0 0 1-.976 1.696A5 5 0 0 0 7 21.978" /> <path d="M14 14.66v1.626a2 2 0 0 0 .976 1.696A5 5 0 0 1 17 21.978" /> <path d="M18 9h1.5a1 1 0 0 0 0-5H18" /> <path d="M4 22h16" /> <path d="M6 9a6 6 0 0 0 12 0V3a1 1 0 0 0-1-1H7a1 1 0 0 0-1 1z" /> <path d="M6 9H4.5a1 1 0 0 1 0-5H6" />',
  "tv": '<!-- @license lucide-static v0.544.0 - ISC --> <svg class="lucide lucide-tv" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" > <path d="m17 2-5 5-5-5" /> <rect width="20" height="15" x="2" y="7" rx="2" />',
  "type": '<!-- @license lucide-static v0.544.0 - ISC --> <svg class="lucide lucide-type" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" > <path d="M12 4v16" /> <path d="M4 7V5a1 1 0 0 1 1-1h14a1 1 0 0 1 1 1v2" /> <path d="M9 20h6" />',
  "underline": '<!-- @license lucide-static v0.544.0 - ISC --> <svg class="lucide lucide-underline" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" > <path d="M6 4v6a6 6 0 0 0 12 0V4" /> <line x1="4" x2="20" y1="20" y2="20" />',
  "unlock-keyhole": '<!-- @license lucide-static v0.544.0 - ISC --> <svg class="lucide lucide-unlock-keyhole" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" > <circle cx="12" cy="16" r="1" /> <rect width="18" height="12" x="3" y="10" rx="2" /> <path d="M7 10V7a5 5 0 0 1 9.33-2.5" />',
  "volume": '<!-- @license lucide-static v0.544.0 - ISC --> <svg class="lucide lucide-volume" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" > <path d="M11 4.702a.705.705 0 0 0-1.203-.498L6.413 7.587A1.4 1.4 0 0 1 5.416 8H3a1 1 0 0 0-1 1v6a1 1 0 0 0 1 1h2.416a1.4 1.4 0 0 1 .997.413l3.383 3.384A.705.705 0 0 0 11 19.298z" />',
  "volume-1": '<!-- @license lucide-static v0.544.0 - ISC --> <svg class="lucide lucide-volume-1" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" > <path d="M11 4.702a.705.705 0 0 0-1.203-.498L6.413 7.587A1.4 1.4 0 0 1 5.416 8H3a1 1 0 0 0-1 1v6a1 1 0 0 0 1 1h2.416a1.4 1.4 0 0 1 .997.413l3.383 3.384A.705.705 0 0 0 11 19.298z" /> <path d="M16 9a5 5 0 0 1 0 6" />',
  "volume-2": '<!-- @license lucide-static v0.544.0 - ISC --> <svg class="lucide lucide-volume-2" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" > <path d="M11 4.702a.705.705 0 0 0-1.203-.498L6.413 7.587A1.4 1.4 0 0 1 5.416 8H3a1 1 0 0 0-1 1v6a1 1 0 0 0 1 1h2.416a1.4 1.4 0 0 1 .997.413l3.383 3.384A.705.705 0 0 0 11 19.298z" /> <path d="M16 9a5 5 0 0 1 0 6" /> <path d="M19.364 18.364a9 9 0 0 0 0-12.728" />',
  "volume-x": '<!-- @license lucide-static v0.544.0 - ISC --> <svg class="lucide lucide-volume-x" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" > <path d="M11 4.702a.705.705 0 0 0-1.203-.498L6.413 7.587A1.4 1.4 0 0 1 5.416 8H3a1 1 0 0 0-1 1v6a1 1 0 0 0 1 1h2.416a1.4 1.4 0 0 1 .997.413l3.383 3.384A.705.705 0 0 0 11 19.298z" /> <line x1="22" x2="16" y1="9" y2="15" /> <line x1="16" x2="22" y1="9" y2="15" />',
  "wand": '<!-- @license lucide-static v0.544.0 - ISC --> <svg class="lucide lucide-wand" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" > <path d="M15 4V2" /> <path d="M15 16v-2" /> <path d="M8 9h2" /> <path d="M20 9h2" /> <path d="M17.8 11.8 19 13" /> <path d="M15 9h.01" /> <path d="M17.8 6.2 19 5" /> <path d="m3 21 9-9" /> <path d="M12.2 6.2 11 5" />',
  "zap": '<!-- @license lucide-static v0.544.0 - ISC --> <svg class="lucide lucide-zap" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" > <path d="M4 14a1 1 0 0 1-.78-1.63l9.9-10.2a.5.5 0 0 1 .86.46l-1.92 6.02A1 1 0 0 0 13 10h7a1 1 0 0 1 .78 1.63l-9.9 10.2a.5.5 0 0 1-.86-.46l1.92-6.02A1 1 0 0 0 11 14z" />',
        ...
        $$('[data-subkey]', row).forEach(input => {
          ...
          if (input.tagName === 'INPUT' || input.tagName === 'SELECT' || input.tagName === 'TEXTAREA') {
            if (item[input.dataset.subkey] === undefined) {
              // v856：带 calc 标记的列（如售后「价格」）保留原始表达式（5+7.5），
              // 仅在详情/只读展示时计算为总值，编辑时仍可看到原表达式。
...
function renderCalendar(year, month, records, commissionRecords = []) {
  ...
  html += '<span class="cal-legend-vbar"></span>';
...
function renderAnnualChart(records, dateField, opts = {}, pageKey) {
  ...
  if (series && series.length) {
    ...
    return `<div class="annual-chart${hasYearnav}"><div class="annual-chart-title"><span class="annual-chart-title-main">${lucide('bar-chart-3',16)} ${esc(title)} · ${yr}年</span>${yearNav}</div><div class="annual-chart-bars">${bars}</div><div class="annual-chart-labels">${labels}</div><div style="display:flex;gap:12px;margin-top:8px;font-size:11px;color:var(--c-text-light)">${legend}</div></div>`;
  }
  ...
  let labels = ''; for (let i = 0; i < 12; i++) labels += `<span>${i + 1}月</span>`;
  const hasYearnav = yearNav ? ' has-yearnav' : '';
    return `<div class="annual-chart${hasYearnav}"><div class="annual-chart-title"><span class="annual-chart-title-main">${lucide('bar-chart-3',16)} ${esc(title)} · ${yr}年</span>${yearNav}</div><div class="annual-chart-bars">${bars}</div><div class="annual-chart-labels">${labels}</div></div>`;
}
...
// ===== v799: 饭圈/二次「重要信息」单人/CP 切换（切换保留内容；最终取值以最后停留页为准） =====
function cdSetCpMode(btn, mode) {
  // v799b: 按钮位于小节标题内（不在 .cd-imp-box 里），必须先找 .form-row 再向下查框
  const rowEl = btn.closest('.form-row');
  const box = rowEl && rowEl.querySelector('.cd-imp-box');
  if (!box) return;
  if (rowEl) rowEl.dataset.cpMode = mode;
  btn.parentElement.querySelectorAll('.lbt-btn').forEach(b => b.classList.toggle('active', b === btn));
  const single = box.querySelector('.cd-imp-single'), cp = box.querySelector('.cd-imp-cp');
  const KEYS = ['charName', 'nickName', 'englishName', 'birthday'];
  if (mode === 'cp') {
    // 切到 CP：把单人已填内容带入第一列（不覆盖 CP 页已填内容）
    KEYS.forEach(k => {
      const s = single && single.querySelector('[data-key="' + k + '"]');
      const p1 = cp && cp.querySelector('[data-key="' + k + '"]');
      if (s && p1 && !p1.value.trim() && s.value.trim()) p1.value = s.value;
    });
  } else {
    // 切回单人：把 CP 页第一列内容带回单人框
    KEYS.forEach(k => {
      const s = single && single.querySelector('[data-key="' + k + '"]');
      const p1 = cp && cp.querySelector('[data-key="' + k + '"]');
      if (s && p1 && p1.value.trim()) s.value = p1.value;
    });
  }
  if (single) single.style.display = mode === 'cp' ? 'none' : '';
  if (cp) cp.style.display = mode === 'cp' ? '' : 'none';
}
// 编辑/回填场景：已有第二人或 CP名 数据时自动切到 CP 页
function cdInitCpModeUI(container) {
  try {
    if (!container) return;
    const box = container.querySelector('.cd-imp-box');
    if (!box) return;
    const CP_KEYS = ['charName2', 'nickName2', 'englishName2', 'birthday2', 'cpName'];
    const has = CP_KEYS.some(k => { const el = box.querySelector('[data-key="' + k + '"]'); return el && String(el.value || '').trim() !== ''; });
    if (has) { const btn = box.closest('.form-row') && box.closest('.form-row').querySelector('[data-cpmode="cp"]'); if (btn) cdSetCpMode(btn, 'cp'); }
  } catch (e) {}
}
// 保存时按最后停留页收敛数据：单人页丢弃第二人/CP名；CP 页保留全部
function cdApplyCpModeToData(container, data) {
  try {
    if (!container) return data;
    const box = container.querySelector('.cd-imp-box');
    const rowEl = box ? box.closest('.form-row') : null;
    const cpOn = rowEl && rowEl.dataset.cpMode === 'cp';
    const CP_KEYS = ['charName2', 'nickName2', 'englishName2', 'birthday2', 'cpName'];
    // 关键：单人/CP 两块存在同名 data-key（第一人四项），隐藏块在 readForm 时会覆盖可见块——
    // 必须按最后停留页显式重取第一人四项，再丢弃/保留第二人与 CP名
    const NAMES = ['charName', 'nickName', 'englishName', 'birthday'];
    const src = cpOn ? '.cd-imp-cp' : '.cd-imp-single';
    NAMES.forEach(k => {
      const el = box.querySelector(src + ' [data-key="' + k + '"]');
      if (el) data[k] = el.value;
    });
    if (cpOn) { data.cpMode = 'cp'; }
    else { data.cpMode = 'single'; CP_KEYS.forEach(k => { delete data[k]; }); }
  } catch (e) {}
  return data;
}
...
function navigate(page) {
  currentPage = page;
  healScrollLock(); // v799: 页面切换前自愈滚动锁（同步后 navigate 重渲染场景）
...
function renderCommDetailPreview(selectedId) {
  ...
  if (cat === '土味' || cat === '封面') {
    ...
    thumbRows = [
      // v799: CP 模式展示 CP名
      ['姓名', (d.cpMode === 'cp' && d.cpName) ? d.cpName : (d.charName || '')],
      ['制品', d.product || ''],
      ['尺寸', d.size || ''],
      ['风格', d.style || ''],
      ['颜色', d.color || ''],
    ...
    thumbRows = [
      ['角色名', (d.cpMode === 'cp' && d.cpName) ? d.cpName : (d.charName || '')],
      ['制品', d.product || ''],
      ['尺寸', d.size || ''],
      ['风格', d.style || ''],
      ['颜色', d.color || ''],
...
function setupFormInteractions(pageKey) {
  ...
  if (pageKey.indexOf('design-commission-detail') === 0) {
    ...
    // v799: 饭圈/二次——已有第二人/CP名数据时自动切到 CP 页
    if (pageKey === 'design-commission-detail-fq' || pageKey === 'design-commission-detail-ec') cdInitCpModeUI(container);
  }
    ...
    if (f.type === 'dynamic-list' || f.type === 'dynamic-products') {
      ...
      items.forEach((item, idx) => {
        ...
        _belowCols.forEach(c => {
          const v = c.calc ? calcExprStr(item[c.subkey]) : item[c.subkey];
          html += `<td class="gb-remark-col"><span class="td-wrap">${esc(v || '')}</span></td>`;
        });
      ...
      if (!items.length) {
        const _cc = _mainCols.length + _belowCols.length + (extraHead ? 2 : 0);
        html += `<tr class="detail-empty-row">${Array(_cc).fill('<td>&nbsp;</td>').join('')}</tr>`;
      }
      html += `</table></div></div>`;
      return;
    }
...
function renderHome() {
  ...
  if (ps.view === 'main') {
    ...
    // 待发布/已发布/月份导航：桌面端移入左列顶部（像每日记录睡眠/饮食按钮），手机端保持原样
    ...
    if (homeTwoCol) {
      ...
      html += '<div class="home-filter-stack">' + homeStatusHtml + homeMonthHtml + '</div>';
    } else {
      html += homeStatusHtml + homeMonthHtml;
    }
...
// 给「有具体称呼/方向」的类型生成标注（兄妹、父子、师徒…）；
// 道侣/好友/同门为对称关系，反向词即关系类型本身（道侣→道侣、好友→好友、同门→同门），
// 由各社会关系字段通过 SOCIAL_FIELD_REVERSE_ALLOWED 自行决定是否采用。
...
function reverseDetailBetween(selfName, otherName, allowedTypes) {
  ...
  // 传空数组[]=该字段禁止任何自动括号；传具体数组=仅允许这些类型
...
function syncOcRelationSocialFields(charName) {
  ...
  ['parents', 'siblings', 'master', 'companion', 'friends', 'fellow'].forEach(f => {
    ...
    derived[f] = allNames.map(n => {
      ...
      // v870：好友栏自定义括号词携带（一次性）——携带后两边互不跟随，她改哪边哪边变
      if (CARRY_FIELDS[f]) {
        const ckey = f + '\u0000' + charName + '\u0000' + n;
        const carried = carryMap[ckey];
        if (carried) {
          if (userDetail === carried) return n + '（' + userDetail + '）'; // 她没动过 → 原样保持（源头改/删都不跟随）
          delete carryMap[ckey]; // 她删掉或改了这个词 → 以她的为准，且之后不再自动携带
  ...
  DB.set('oc_carry_dismissed_v870', dismissedMap);
...
// v856：道侣/好友/同门支持自身对应括号——在 v855 基础上为对称关系字段补上（道侣）/（好友）/（同门）标注
function normalizeOcProfileReverseDetailV856() {
  if (DB.get('oc_profile_reverse_v856')) return;
  DB.list('ocCharacters').forEach(c => { if (c && c.name) syncOcRelationSocialFields(c.name); });
  ...
  mod.fields.forEach(f => {
    ...
    if (f.type === 'custom') {
      ...
      doc.querySelectorAll('.style-color-col').forEach(col => {
        if (col.closest('.cd-imp-cp')) return; // v799: 单人态跳过 CP 备用列
    ...
    if (f.type === 'dynamic-list') {
      ...
      if (items.length) {
        ...
        // v856：空列表加一行带格子的空白占位，避免光杆表头/全白无格
        h += `<tr class="detail-empty-row">${Array(cols.length).fill('<td>&nbsp;</td>').join('')}</tr>`;
      }
      h += '</table></div></div>';
      return;
    }
...
function cdRenderCustomFieldRows(f, r, mode) {
  ...
  if (doc.querySelector('.cd-imp-box') && cdIsCpRecord(r)) {
    ...
    const arr = [];
    cols.forEach(col => {
      if (col.closest('.cd-imp-cp')) return; // v799: 跳过 CP 备用列
...
// v799: 「文案库」按钮注入（弹窗/独立填写页共用）；v799b 按钮改周/月/年同款小按钮（.tpl-inline-btn 已换肤）
function cdInjectTplBtn(html) {
  return html.replace(
    /(<label class="form-label">)([^<]*)(<\/label>)(\s*<textarea class="form-textarea" data-key="copyText")/,
    (m, a, lbl, c, ta) => `<div class="form-label-row">${a}${lbl}${c}<button type="button" class="tpl-inline-btn" onclick="openTextTemplatePicker('copyText')">${lucide('file-text',15)} 文案库</button></div>${ta}`
  );
}
...
function collectCdFormData(catKey) {
  // v799: 弹窗未打开时回退 #mainBody（独立页/兜底），并按最后停留页收敛 CP 数据
...
// v767：分类标签分页（自适应宽标签 + ‹ › 翻页）；v772：每页数量按容器实际宽度动态计算（能放几个放几个，放不下翻页）
let _tplTabMeasureSpan = null;
function tplTabTextWidth(label) {
  if (!_tplTabMeasureSpan) {
    _tplTabMeasureSpan = document.createElement('span');
    _tplTabMeasureSpan.style.cssText = 'position:absolute;visibility:hidden;white-space:nowrap;font-size:13px;font-weight:600;left:-9999px;top:-9999px';
    document.body.appendChild(_tplTabMeasureSpan);
  }
  _tplTabMeasureSpan.textContent = label;
  return _tplTabMeasureSpan.offsetWidth;
}
function tplComputePerPage(box, cats) {
  const avail = (box && box.clientWidth) || 0;
  if (!avail || !cats.length) return 4;
  // 三档标签内边距（宽→窄）：24/20/16px，首标签再减 6px，相邻 margin-left:-10px 拼合
  const STEPS = [[24, 18], [20, 15], [16, 14]];
  const tabW = (label, pos, pad, padFirst) => {
    const t = tplTabTextWidth(label);
    return pos === 0 ? t + padFirst + pad : t + pad * 2 - 10;
  };
  const fit = (reserveNav, pad, padFirst) => {
    let total = 0, n = 0;
    for (let i = 0; i < cats.length; i++) {
      const c = cats[i];
      const label = (typeof c === 'string') ? c : c.label;
      const w = tabW(label, n, pad, padFirst); // n = 本页内位置（每页首个标签都带 :first-child 样式）
      if (total + w > avail - (reserveNav ? 62 : 0)) break;
      total += w; n++;
    }
    return Math.max(1, n);
  };
  // v778：从宽到窄选第一个能一排放完的档；都要翻页时选每页放得最多的档（并列取更宽），
  // 避免右侧还有大空余却用到最窄档
  const setMode = (pad) => {
    if (!box) return;
    box.classList.toggle('mode-wide', pad === 24);
    box.classList.toggle('mode-mid', pad === 20);
  };
  let best = null;
  for (const [pad, padFirst] of STEPS) {
    const full = fit(true, pad, padFirst);
    if (full >= cats.length) {
      setMode(pad);
      return fit(false, pad, padFirst);
    }
    const per = fit(true, pad, padFirst);
    if (!best || per > best.per) best = { pad, padFirst, per };
  }
  setMode(best.pad);
  return best.per;
}
function tplCatsPagerHTML(cats, activeKey, page, pickFn, navFn, per) {
  const PER = Math.max(1, per || 4);
...
function renderCommCatTabs() {
  ...
  const r = tplCatsPagerHTML(cats, _tplLibCat, _tplLibCatPage, 'setTplLibCat', 'navTplLibCatPage', tplComputePerPage(box, cats));
...
function openTextTemplateLib() {
  let html = '<div class="tpl-lib-folder">';
  // v780：顶部大标题回归 modal-header（openModal 首参）；内容区小标题保留（v781 改名）
  html += '<div class="tpl-new-title">文案库</div>';
...
function setTxtTplPickerCat(fieldKey) {
  ...
  if (raw) _txtTplPickerCat = raw;
  if (el) el.value = _txtTplPickerCat;
...
function openTextTemplatePicker(fieldKey) {
  ...
  ov.innerHTML = `<div class="txt-tpl-picker-card"><div class="txt-tpl-picker-head">文案库<button type="button" class="txt-tpl-picker-close" onclick="closeTextTemplatePicker()">✕</button></div><div class="txt-tpl-picker-body">${bodyHTML}</div><div class="txt-tpl-picker-foot"><button type="button" class="btn btn-ghost" onclick="closeTextTemplatePicker()">关闭</button></div></div>`;
  document.body.appendChild(ov);
...
function saveCdClientForm(pageKey, standalone) {
  const mod = MODULES[pageKey];
  // v799: 弹窗未打开（独立填写页）时严禁读静态 #modalBody 空容器——v777 起单主提交「空表」的根因
  const _ov = document.getElementById('modalOverlay');
...
function init() {
  const s = getSettings();
  applyTheme(s.theme);
  setInterval(healScrollLock, 3000); // v799: 滚动锁兜底自愈（弹窗全关时每 3 秒检查一次，防同步/异步时序卡锁）
